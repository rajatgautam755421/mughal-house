      ...
      {open && (
        ...
        >
          ...
          <div
            ...
            style={{
              height: "2px",
              background: "linear-gradient(90deg, #13245e 0%, #1e4f9c 50%, #b08830 100%)",
            }}
          />
          ...
          {/* Messages */}
          <div className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-3" style={{ background: "#f3efe6" }}>
            {messages.map((msg) => (
